...
<header  class="header" id="header">
  ...
  <div class="container ">
    <div class="row display-flex" style="padding: 15px ">
      ...
      <div class="box-icon-right col-md-4 display-flex display-none " style="flex-basis: content;">
        <div class="row">
					<div class="box-phone   display-flex  col-md-6">
	        ...
	        <span  >Hỗ trợ 24h</span>
							<a title="1900 6750" href="tel:19006750" style="; color:#dd0115 ; font-weight: 600">1900 6750</a>
						</div>
					</div>
          <div class="box-phone  ">
            <div>
					<a href="/he-thong-cua-hang" title="Số hệ thống" class="hethong-header display-flex flex-colum">
