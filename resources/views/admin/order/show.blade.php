          ...
          <h2 class="page-header">
            <div style="display: inline-flex; align-items: center;">
              <div style="width: 30px; margin-right: 5px;">
                <img src="{{ asset('images/favicon.png') }}" alt="Xphone Logo" style="width: 100%; height: auto; object-fit: cover;">
              </div>
              <div style="color: #f33;">Xphone</div>
            </div>
        ...
        <div class="row">
          <div class="col-md-3 col-sm-3 col-xs-3">
            ...
            <address>
              ...
              Email: vanduy@gmail.com<br>
              Address: 200 ha huy tap dak dak.
            </address>
          </div>
          <div class="col-md-3 col-sm-3 col-xs-3">
            To: <br>
