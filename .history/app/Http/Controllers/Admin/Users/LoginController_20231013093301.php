...
class LoginController extends Controller
{
    public function index()
    {
        ...
        // Kiểm tra xem phiên "admin-login" đã tồn tại hay chưa
        if (Session::has('admin-login')) {
            $adminLoginData = Session::get('admin-login');
            // Sử dụng dữ liệu phiên "admin-login" ở đây nếu cần
    ...
    public function store(Request $request)
    {
        ...
        // Lưu thông tin đăng nhập thất bại vào phiên "admin-login" để sử dụng trong index
        Session::put('admin-login', $request->all());
